package com.android.myepubs.helpers;
...
public class MyEpubsDBHelper extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "my_epubs.db";
    private static final int DATABASE_VERSION = 1;

    private static final String CONTENT_AUTHORITY = "com.android.myepubs.data";
    private static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    public MyEpubsDBHelper(Context context) {
