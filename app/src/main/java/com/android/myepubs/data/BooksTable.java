package com.android.myepubs.data;
...
import com.android.myepubs.helpers.MyEpubsDBHelper;
...
public class BooksTable implements BaseColumns {
    ...
    private static final Uri CONTENT_URI =
            MyEpubsDBHelper.getBaseContentUri().buildUpon().appendPath(PATH_BOOKS).build();

    private static final String CONTENT_TYPE = MyEpubsDBHelper
            .getContentType(ContentResolver.CURSOR_DIR_BASE_TYPE, PATH_BOOKS);

    private static final String CONTENT_ITEM_TYPE = MyEpubsDBHelper
